...
> Legacy note (2026-04-30): Flash/Pro triage is not a production path. Current
> production uses mandatory Qwen OCR enrichment followed by Stage 02
> `findings_only_qwen_pair` single-block analysis with `openai/gpt-5.4`.
