...
PARTS = {
    ...
    EvidenceType.GRAPHIC_SCHEME: ('raster', 'scheme', 'labels', 'notes', 'related_nodes'),
...
class EvidenceRequirement:
    ...
    required_type: EvidenceType | None = None
    ...
    def __post_init__(self):
        ...
        object.__setattr__(self, 'required_type', EvidenceType(self.required_type or self.evidence_type))
    ...
    @property
    def parts(self):
        return set(self.required_parts or PARTS[self.required_type])
...
def assess(requirement, evidence):
    ...
    if located and not matched:
        ...
        complete_units = [e for e in matched if e.get('scope_binding') == r.scope_binding
                          ...
                          and e.get('requirement_id') == r.requirement_id
                          and e.get('selected_evidence_type') == r.required_type
                          and (r.required_type not in {EvidenceType.GRAPHIC_REGION, EvidenceType.GRAPHIC_SCHEME} or e.get('raster'))]
