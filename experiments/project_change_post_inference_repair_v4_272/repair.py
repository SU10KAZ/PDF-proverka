...
def repair(raw, packet, context, facts=()):
    ...
    n.update(schema='PAIR_A_POST_INFERENCE_REPAIR/4', status='REVIEW' if issues else 'NORMALIZED', issues=issues,
        ...
        admission_order=['NORMALIZATION_V1', 'BINDING_V1', 'APPLICABILITY_V2_V3', 'ROLE_SCOPED_MODALITY_V4', 'NUMERIC_CONFLICT_GUARD', 'F2', 'V4', 'FINAL_ADMISSION'])
    n['transformations'].append(dict(path='role_scoped_modality_v4', before=None, after=app,
