...
ARTIFACT_PATHS: dict[str, Callable[[str, str], Path]] = {
    ...
    "sheet_matcher_v4_shadow": paths.production_sheet_matcher_v4_shadow_path,
    ...
    "document_inconsistencies": paths.production_document_inconsistencies_path,
    "electrical_table_changes": paths.production_electrical_table_changes_path,
    "preliminary_report": paths.production_preliminary_report_path,
    "ai_v2_run": paths.production_ai_v2_run_path,
    "ai_v2_materialization": paths.production_ai_v2_materialization_path,
    "ai_question_closure": paths.production_ai_question_closure_path,
    "human_review_plan": paths.production_human_review_plan_path,
    "presentation_groups": paths.production_presentation_groups_path,
