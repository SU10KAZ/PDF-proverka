...
def production_text_fact_ownership_path(session_id: str, pair_id: str) -> Path:
    return production_dir(session_id, pair_id) / "text_fact_ownership.json"
...
__all__ = [
    ...
    "production_text_fact_ownership_path",
