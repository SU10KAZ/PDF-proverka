...
Замечание об отсутствии с пустым `absence_checked` считается непроверенным: оно будет
перепроверено по всему документу, и если данные найдутся где-либо ещё — понижено до
«ПРОВЕРИТЬ ПО СМЕЖНЫМ». Заполняй `absence_checked` честно — это защищает верные находки."""
